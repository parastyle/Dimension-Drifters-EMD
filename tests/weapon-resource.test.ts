...
describe("Drive formula v1", () => {
  it("covers the frozen 389-weapon post-B63/B66 catalog in deterministic id order", () => {
    ...
    // Deliberately literal delivery ownership: the newly integrated profiles enter their real branches.
    expect(census).toEqual({ melee: 181, thrown: 27, gun: 148, cast: 5, beam: 24, zone: 4 });
  });
