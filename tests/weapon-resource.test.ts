...
describe("Drive formula v1", () => {
  it("covers the frozen 394-weapon post-B63/B66 catalog in deterministic id order", () => {
    ...
    // Deliberately literal delivery ownership: all five new profiles must enter their authored branches.
    expect(census).toEqual({ melee: 181, thrown: 27, gun: 152, cast: 5, beam: 25, zone: 4 });
  });
