...
/**
 * Deterministic formula output for every catalogued weapon id except the built-in fists fallback.
 * Archived profiles remain resolvable so old receipts/instances never dangle while the join migration
 * converts owned copies.
 */
