...
const RANGED_FAMILY =
  /^(?:auto-rifle|blunderbuss|concussion-cannon|exotic-ranged|grenade-launcher|gun|hand-cannon|heavy-ordnance|lever-rifle|light machine gun|machine-pistol|marksman-rifle|nailgun|pistol|railgun|scrap-cannon|shotgun)$/i;
