...
const RANGED_FAMILY =
  /^(?:anti-materiel-rifle|auto-rifle|automatic-shotgun|battle-rifle|beam-sidearm|blunderbuss|bullpup-rifle|caseless-carbine|coil-accelerator|concussion-cannon|continuous-beam-rifle|energy-shotgun|exotic-ranged|grenade-launcher|gun|hand-cannon|heavy-ordnance|integrally-suppressed-rifle|lever-rifle|light machine gun|machine-pistol|marksman-rifle|nailgun|pistol|pistol-calibre-carbine|puck-launcher|rail-pistol|railgun|rimfire-rifle|scrap-cannon|seed-launcher|semi-auto carbine|shotgun|smart-burst-rifle)$/i;
