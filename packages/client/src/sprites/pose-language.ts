...
const RANGED_FAMILY =
  /^(?:anti-materiel-rifle|auto-rifle|automatic-shotgun|battle-rifle|blunderbuss|concussion-cannon|exotic-ranged|grenade-launcher|gun|hand-cannon|heavy-ordnance|lever-rifle|light machine gun|machine-pistol|marksman-rifle|nailgun|pistol|pistol-calibre-carbine|puck-launcher|rail-pistol|railgun|rimfire-rifle|scrap-cannon|seed-launcher|semi-auto carbine|shotgun)$/i;
